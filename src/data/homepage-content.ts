  ...
  testimonials: [
    {
      ...
      role: "Founder & Owner",
      restaurant: "L'Etoile Bistro",
      quote: "DIYNEZA saved us over 8% in ingredient waste in our first month. The POS is fast, and the recipe costing tool is incredibly precise.",
    ...
    },
    {
      ...
      restaurant: "Spice Junction Chains",
      quote: "Managing 14 outlets was a nightmare of spreadsheet consolidation. Now, changing a menu price across all cities takes exactly 15 seconds.",
    ...
    },
    {
      ...
      restaurant: "Glow Juice Cafe",
      quote: "Our servers love the table QR ordering. It reduces human error and allows them to focus on hospitality rather than punching bills.",
